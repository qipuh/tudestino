...
import frontDeskRoutes from './modules/front-desk/front-desk.routes.js';
import housekeepingRoutes from './modules/housekeeping/housekeeping.routes.js';
import billingRoutes from './modules/billing/billing.routes.js';
import rateManagementRoutes from './modules/rate-management/rate-management.routes.js';
...
app.use('/api/rate-management', rateManagementRoutes);
