...
import { X, Save, Check, Loader, User, MapPin, Heart, Globe, Lock, Mail } from 'lucide-react';
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                maxLength={500}
                placeholder="Cuéntanos sobre tu pasión por viajar, tus experiencias y qué te motiva..."
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
              />
              <div className="flex justify-between items-center mt-1">
                <p className="text-xs text-gray-500">Comparte tu pasión por los viajes</p>
                <p className={`text-xs font-medium ${formData.travelBio.length > 450 ? 'text-orange-500' : 'text-gray-500'}`}>
                  {formData.travelBio.length}/500
                </p>
              </div>
            </div>
