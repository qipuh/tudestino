...
const basicAmenities = [
  ...
  { value: 'smart_tv', label: 'Smart TV', icon: 'tv-outline' },
  { value: 'cable_tv', label: 'TV por cable', icon: 'tv-outline' },
  ...
  { value: 'work_area', label: 'Zona de trabajo', icon: 'briefcase-outline' },
  { value: 'safe_box', label: 'Caja fuerte', icon: 'lock-closed-outline' },
  { value: 'minibar', label: 'Minibar', icon: 'wine-outline' },
  { value: 'refrigerator', label: 'Refrigerador', icon: 'snow-outline' },
  { value: 'microwave', label: 'Microondas', icon: 'radio-outline' },
  ...
  { value: 'closet', label: 'Closet/Armario', icon: 'cube-outline' },
  { value: 'seating_area', label: 'Sillones/Zona de estar', icon: 'home-outline' },
  { value: 'room_service', label: 'Servicio a la habitación', icon: 'restaurant-outline' },
];
...
const bathroomAmenities = [
  ...
  { value: 'rain_shower', label: 'Ducha tipo lluvia', icon: 'rainy-outline' },
  { value: 'bathtub', label: 'Bañera', icon: 'square-outline' },
  { value: 'jacuzzi', label: 'Jacuzzi', icon: 'ellipse-outline' },
  { value: 'hot_tub', label: 'Tina de hidromasaje', icon: 'ellipse-outline' },
  { value: 'hydromassage', label: 'Hidromasaje', icon: 'fitness-outline' },
  { value: 'bidet', label: 'Bidé', icon: 'water-outline' },
  { value: 'toiletries', label: 'Artículos de aseo', icon: 'flower-outline' },
  { value: 'premium_toiletries', label: 'Artículos de aseo premium', icon: 'diamond-outline' },
...
const viewTypes = [
  ...
  { value: 'panoramic', label: 'Vista panorámica', icon: 'scan-outline' },
  { value: 'sea', label: 'Vista al mar', icon: 'water-outline' },
  { value: 'beach', label: 'Vista a la playa', icon: 'boat-outline' },
  { value: 'mountain', label: 'Vista a la montaña', icon: 'triangle-outline' },
  { value: 'river', label: 'Vista al río', icon: 'water-outline' },
  { value: 'lake', label: 'Vista al lago', icon: 'water-outline' },
  { value: 'garden', label: 'Vista al jardín', icon: 'leaf-outline' },
  { value: 'pool', label: 'Vista a la piscina', icon: 'water-outline' },
  { value: 'courtyard', label: 'Vista al patio', icon: 'home-outline' },
...
const extraAmenities = [
  ...
  { value: 'private_entrance', label: 'Entrada independiente', icon: 'enter-outline' },
  { value: 'kitchen', label: 'Cocina completa', icon: 'restaurant-outline' },
  { value: 'kitchenette', label: 'Cocineta', icon: 'fast-food-outline' },
  { value: 'dining_area', label: 'Zona de comedor', icon: 'fast-food-outline' },
  { value: 'washing_machine', label: 'Lavadora', icon: 'refresh-circle-outline' },
  { value: 'dryer', label: 'Secadora', icon: 'sunny-outline' },
  { value: 'iron_board', label: 'Plancha y tabla', icon: 'grid-outline' },
  { value: 'soundproof', label: 'Insonorizada', icon: 'volume-mute-outline' },
  { value: 'blackout_curtains', label: 'Cortinas blackout', icon: 'moon-outline' },
  { value: 'fireplace', label: 'Chimenea', icon: 'flame-outline' },
  { value: 'sofa_bed', label: 'Sofá cama', icon: 'bed-outline' },
  { value: 'extra_bed', label: 'Cama adicional', icon: 'bed-outline' },
  { value: 'baby_crib', label: 'Cuna para bebé', icon: 'happy-outline' },
  { value: 'games_area', label: 'Zona de juegos', icon: 'game-controller-outline' },
  { value: 'smoking', label: 'Permitido fumar', icon: 'cloud-outline' },
  { value: 'non_smoking', label: 'No fumar', icon: 'ban-outline' },
  { value: 'pet_friendly', label: 'Admite mascotas', icon: 'paw-outline' },
