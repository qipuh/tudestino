...
import { getLocation, searchBusinesses, getLocationSuggestions, searchAll, searchProperties } from './search.controller.js';
...
// GET /api/search/properties - Búsqueda avanzada de propiedades (usada por la app móvil)
