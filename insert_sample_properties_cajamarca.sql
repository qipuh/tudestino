...
INSERT INTO rooms (id, propertyId, roomType, name, guestCapacity, beds, pricePerNight, amenities, images, isAvailable, createdAt, updatedAt) VALUES
(@room1, @uuid1, 'standard', 'Habitación Standard Vista Ciudad', 2, '[{"type": "double", "count": 1}]', 180.00, 
...
(@room2, @uuid1, 'suite', 'Suite Ejecutiva Plaza de Armas', 4, '[{"type": "king", "count": 1}, {"type": "sofa_bed", "count": 1}]', 320.00,
...
INSERT INTO rooms (id, propertyId, roomType, name, guestCapacity, beds, pricePerNight, amenities, images, isAvailable, createdAt, updatedAt) VALUES
(@room3, @uuid2, 'standard', 'Habitación Colonial', 2, '[{"type": "double", "count": 1}]', 150.00,
...
(@room4, @uuid2, 'deluxe', 'Habitación Deluxe Marqués', 3, '[{"type": "queen", "count": 1}, {"type": "single", "count": 1}]', 220.00,
...
INSERT INTO rooms (id, propertyId, roomType, name, guestCapacity, beds, pricePerNight, amenities, images, isAvailable, createdAt, updatedAt) VALUES
(@room5, @uuid3, 'standard', 'Habitación Superior', 2, '[{"type": "double", "count": 1}]', 240.00,
...
(@room6, @uuid3, 'suite', 'Suite Ejecutiva Costa del Sol', 4, '[{"type": "king", "count": 1}, {"type": "sofa_bed", "count": 1}]', 420.00,
...
INSERT INTO rooms (id, propertyId, roomType, name, guestCapacity, beds, pricePerNight, amenities, images, isAvailable, createdAt, updatedAt) VALUES
(@room7, @uuid4, 'standard', 'Habitación Termal', 2, '[{"type": "double", "count": 1}]', 195.00,
...
(@room8, @uuid4, 'deluxe', 'Suite Termal con Jacuzzi', 4, '[{"type": "king", "count": 1}, {"type": "sofa_bed", "count": 1}]', 350.00,
...
INSERT INTO rooms (id, propertyId, roomType, name, guestCapacity, beds, pricePerNight, amenities, images, isAvailable, createdAt, updatedAt) VALUES
(@room9, @uuid5, 'standard', 'Habitación Familiar', 4, '[{"type": "double", "count": 1}, {"type": "single", "count": 2}]', 140.00,
...
(@room10, @uuid5, 'standard', 'Habitación Doble', 2, '[{"type": "double", "count": 1}]', 120.00,
'["wifi", "tv", "heating", "private_bathroom", "city_view"]',
'["https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800", "https://images.unsplash.com/photo-1584132915807-fd1f5fbc078f?w=800"]',
true, NOW(), NOW());

-- Habitaciones Departamento Centro Histórico
INSERT INTO rooms (id, propertyId, roomType, name, guestCapacity, beds, pricePerNight, amenities, images, isAvailable, createdAt, updatedAt) VALUES
(@room11, @uuid6, 'apartment', 'Departamento Completo 2 Dormitorios', 6, '[{"type": "double", "count": 2}, {"type": "sofa_bed", "count": 1}]', 280.00,
...
INSERT INTO rooms (id, propertyId, roomType, name, guestCapacity, beds, pricePerNight, amenities, images, isAvailable, createdAt, updatedAt) VALUES
(@room12, @uuid7, 'apartment', 'Departamento 3 Dormitorios Vista Panorámica', 8, '[{"type": "king", "count": 1}, {"type": "double", "count": 2}, {"type": "sofa_bed", "count": 1}]', 380.00,
...
INSERT INTO rooms (id, propertyId, roomType, name, guestCapacity, beds, pricePerNight, amenities, images, isAvailable, createdAt, updatedAt) VALUES
(@room13, @uuid8, 'private', 'Habitación Colonial Privada', 2, '[{"type": "double", "count": 1}]', 95.00,
'["wifi", "garden", "historical", "shared_kitchen", "private_bathroom", "colonial_architecture"]',
...
INSERT INTO rooms (id, propertyId, roomType, name, guestCapacity, beds, pricePerNight, amenities, images, isAvailable, createdAt, updatedAt) VALUES
(@room14, @uuid9, 'family', 'Habitación Familiar Los Eucaliptos', 4, '[{"type": "double", "count": 1}, {"type": "bunk", "count": 1}]', 110.00,
'["wifi", "garden", "family_friendly", "private_bathroom", "shared_areas", "quiet_area"]',
